  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Link href="/twojastara/entries?type=game" className="block p-6 bg-white rounded-xl shadow">
          <h2 className="text-slate-500 text-sm font-medium">Games</h2>
          <p className="text-3xl font-bold text-slate-800 mt-1">{gamesCount}</p>
        </Link>
        <Link href="/twojastara/entries?type=app" className="block p-6 bg-white rounded-xl shadow">
          <h2 className="text-slate-500 text-sm font-medium">Apps</h2>
          <p className="text-3xl font-bold text-slate-800 mt-1">{appsCount}</p>
        </Link>
        <Link href="/twojastara/articles" className="block p-6 bg-white rounded-xl shadow">
        ...
        <Link href="/twojastara/categories" className="block p-6 bg-white rounded-xl shadow">
